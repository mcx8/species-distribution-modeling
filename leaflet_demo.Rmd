...
# provided that you use the same seed value. This is useful for debugging, sharing code, # and ensuring that others can reproduce your results exactly.
...
```{r}
# currentClimRasterStack is huge and it isn't reasonable to predict over whole world
...
leaflet(options = leafletOptions(zoomControl = FALSE, # Removes zoom button
                                 attributionControl = FALSE, # Removes banner at bottom
                                 maxZoom = 19)) %>% 
  # Add basemap
